...
app.use('/media', verifyToken, can('admin', 'guest'), mediaRouter);
app.use('/orders', verifyToken, can('admin', 'guest'), orderPaymentsRouter);
...
app.use('/my-courses', verifyToken, can('admin', 'guest'), myCoursesRouter);
app.use('/reviews', verifyToken, can('admin', 'guest'), reviewsRouter);
